...
def resumen(datos):
    '''
    Muestra por pantalla un resumen de la ronda actual. Puntaje, aciertos, erroes, palabra correcta e incorrectas.
    Hecho por: Brian Duarte
    Modificado por:
    
    '''
    resultados=(datos[ACIERTOS]*PUNTAJE_CORRECTA)-(datos[ERRORES]*PUNTAJE_INCORRECTA)
...
def iniciar_partida():
    """
    Inicia la partida cargando y procesando la estructura de datos.
    Hecho por: Walter Britez
    Modificado por: Brian Duarte / Walter Britez / Nahuel Cabrera / Felipe Gazcon / Genesis Pinto
    """
